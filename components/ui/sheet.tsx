...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card p-6 shadow-card transition ease-out duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn(
      "font-display text-lg font-semibold tracking-heading",
      className
    )}
    {...props}
  />
